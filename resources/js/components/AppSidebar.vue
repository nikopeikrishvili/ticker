...
<template>
    <Sidebar collapsible="icon" variant="floating">
        ...
        <SidebarContent>
            <SidebarGroup v-for="group in navMain" :key="group.title" :data-tour="group.title === 'ნავიგაცია' ? 'sidebar' : group.title === 'მოქმედებები' ? 'sidebar-actions' : undefined">
            ...
            <SidebarGroup class="mt-auto" data-tour="nav-pages">
        ...
        <SidebarFooter>
            <SidebarMenu>
                <SidebarMenuItem>
                    <SidebarMenuButton v-if="showSettings" @click="showSettings" tooltip="პარამეტრები" data-tour="settings-btn">
                        <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
